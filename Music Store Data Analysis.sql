Q.1 Who is the senior most employee from the job title?
...
Q.3 What are top 3 values in total invoice?
...
Q.7 Lets invite the artists who have written the most rock music in our dataset. Write a query that 
...
Q.9 Find how much amount spent by each customer on artists? Write a query to return customer name, artist
...
Q.11 Write a query that determines the customer that has spent the most on music for each country. Write
